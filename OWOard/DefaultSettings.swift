...
class DefaultSettings: ExtraView, UITableViewDataSource, UITableViewDelegate {
    ...
    var settingsList: [(String, [String])] {
        get {
            return [
                ("OWOard Settings", [doUWU, doClap, doCaps, doWBracket, doBBracket, doHearts]),
                ("Stylize Text", [doStyle, doDouble, doFancy, doGothic, doBubbles, doUpsideDown, doZalgo, doFancyBold, doSquiggle, doSquares, doSign, doNeon, doAlien, doKanji, doMandarin, doRussian]),
                ("Extra Settings", [kAutoCapitalization, kKeyboardClicks, kSmallLowercase])
            ]
        }
    }
    var settingsNames: [String:String] {
        get {
            return [
                doUWU: "UWU",
                doStyle: "Stylize Text",
                randoCaps: "cApS",
                doClap: "👏",
                doZalgo: "Zalgo",
                doFancy: "Fancy",
                doDouble: "Double Stack",
                doGothic: "Gothic",
                doCaps: "do cApS",
                doBubbles: "Bubbles",
                doBBracket: "Black Bracket",
                doWBracket: "White Bracket",
                doHearts: "Hearts",
                doFancyBold: "Fancy Bold",
                doSquares: "Squares",
                doRussian: "Russian Style",
                doKanji: "Asian Style 1",
                doMandarin: "Asian Style 2",
                doAlien: "Alien",
                doNeon: "Neon",
                doSquiggle: "Squiggle",
                doSign: "Sign Language",
                doUpsideDown: "Flipped",
    ...
    var settingsNotes: [String: String] {
        get {
            return [
                ...
                kSmallLowercase: "Huge thanks to Archagon & UnifyBadPirate\non Github for creating a imitation Apple keyboard.\nNothing else I've seen looks anywhere as nice as it! Go check them out on Github!",
                doStyle: "Only one text style/font will actually be registered when typing. Please make sure to enable only one!"
            ]
        }
    }
